<x-backend.dashboard title="Edit Sub Category">

    <!-- Page Heading -->

    <div class="d-flex justify-content-between align-items-center mb-4">

        <h1 class="h3 text-gray-800">Edit Sub Category</h1>

        <a class="btn btn-primary" href="{{ route('admin.sub-categories.index') }}"><i class="fas fa-long-arrow-alt-left"></i>
